...
- **Sindel cross-continuity claim history:** Sindel and Jerrod now span Original, Reboot, and New Era evidence through scoped Facts for royal role, marriage, and Jerrod's death history. Original ending-level Shao Kahn killer attribution, Reboot Aftermath's direct Sindel attribution, and New Era's broader sourced murder outcome coexist without inventing a universal killer or automatic retcon. `/claims?q=Sindel` provides a focused review entry point.
