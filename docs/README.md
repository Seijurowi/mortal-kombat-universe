...
- [`PHASE5_SINDEL_CLAIM_HISTORY_MANUAL_VERIFICATION.md`](./PHASE5_SINDEL_CLAIM_HISTORY_MANUAL_VERIFICATION.md) — Original/Reboot/New Era Sindel role, Jerrod marriage/death claim families, evidence-strength variation, deep-linked claim filtering, and short maintainer test cases.
- [`PHASE5_ORIGINAL_VICTOR_ATTRIBUTION_AUDIT_MANUAL_VERIFICATION.md`](./PHASE5_ORIGINAL_VICTOR_ATTRIBUTION_AUDIT_MANUAL_VERIFICATION.md) — MKII/MK3/MK4 ending-evidence audit, broad-outcome-vs-individual-victor discipline, and the explicit expected absence of unsupported canon Liu Kang victor attribution.
